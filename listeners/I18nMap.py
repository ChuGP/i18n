...
class I18nMap:
    ...
    def __init__(self, translation_file,locale='en-US'):
        ...
        self.translation_file = translation_file #i18ntranslation dict
    ...
    '''
    def locator(self, xpath, new_locate_rule={}):
        ...
        locate_rule = combine_locate_rule(new_locate_rule)
